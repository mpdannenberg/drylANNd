...
% destroyed
for i = 1:n
    % Convert 16day mean latent heat flux to 16day mean daily ET
...
print('-dtiff','-f1','-r300','./output/DrylANNd_variableimportance_16day.tif')
close all;
...
set(gcf,'PaperPositionMode','auto','InvertHardCopy','off')
print('-dtiff','-f1','-r300','./presentation/DrylANNd_variableimportance_16day.tif')
close all;
