...
for i = 1:n
    ...
    nets = DrylANNd(strcmp({DrylANNd.IGBP}, Ameriflux_16day(i).IGBP)).NNets;
...
print('-dtiff','-f1','-r300','./output/DrylANNd_variableimportance_GPP_16day.tif')
close all;
...
set(gcf,'PaperPositionMode','auto','InvertHardCopy','off')
print('-dtiff','-f1','-r300','./output/DrylANNd_variableimportance_NEE_16day.tif')
close all;
...
set(gcf,'PaperPositionMode','auto','InvertHardCopy','off')
print('-dtiff','-f1','-r300','./output/DrylANNd_variableimportance_ET_16day.tif')
close all;
