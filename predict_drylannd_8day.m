...
for t = 1:nt
    ...
    X = [MCD43_NDVI_8day(t, ai <= ai_threshold)
        MCD43_EVI_8day(t, ai <= ai_threshold)
        MCD43_NIRv_8day(t, ai <= ai_threshold)
        MCD43_kNDVI_8day(t, ai <= ai_threshold)
        MCD43_LSWI1_8day(t, ai <= ai_threshold)
        MCD43_LSWI2_8day(t, ai <= ai_threshold)
        MCD43_LSWI3_8day(t, ai <= ai_threshold)
        MOD11_Day_8day(t, ai <= ai_threshold)
        MOD11_Night_8day(t, ai <= ai_threshold)
        MYD11_Day_8day(t, ai <= ai_threshold)
        MYD11_Night_8day(t, ai <= ai_threshold)
...
save('./output/DrylANNd_8day_prediction.mat', 'GPP','ET','NEE',...
